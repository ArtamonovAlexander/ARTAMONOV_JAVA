...
public class UserRepositoryImpl implements UserRepository {
    ...
    //language=sql
    private static final String SQL_SAVE = "insert into users (firstName, lastName, login, password_hash) values (?, ?, ?, ?)";
    //language=sql
    ...
    public void save(User user) {
        jdbcTemplate.update(SQL_SAVE, user.getFirstName(), user.getLastName(), user.getLogin(), user.getPassword_hash());
    }
