...
import com.company.repositories.jdbc.CarsRepositoryJdbcImpl;
...
public class MainOnJdbcRepository {
    ...
    public static void main(String[] args) {
        ...
        CarsRepository carsRepository = new CarsRepositoryJdbcImpl(connector);
...
//        System.out.println(usersRepository.find(2L));
          carsRepository.findByOwner(3L).print();
//        System.out.println(carsRepository.find(1L));
    }
}
